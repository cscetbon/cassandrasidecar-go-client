...
// RestartOperationResponse struct for RestartOperationResponse
...
func (o RestartOperationResponse) MarshalJSON() ([]byte, error) {
...
type NullableRestartOperationResponse struct {
	value *RestartOperationResponse
	isSet bool
}

func (v NullableRestartOperationResponse) Get() *RestartOperationResponse {
	return v.value
}

func (v *NullableRestartOperationResponse) Set(val *RestartOperationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRestartOperationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRestartOperationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestartOperationResponse(val *RestartOperationResponse) *NullableRestartOperationResponse {
	return &NullableRestartOperationResponse{value: val, isSet: true}
}

func (v NullableRestartOperationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestartOperationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
